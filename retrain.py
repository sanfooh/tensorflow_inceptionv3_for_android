...
def maybe_download_and_extract(data_url,architecture):
...
def create_model_info(architecture):
  ...
  if architecture == 'inception_v3':
    ...
    data_url = 'https://deepdetect.com/models/tf/inception_v4.pb' #this won't make any difference
...
def main(_):
  ...
  maybe_download_and_extract(model_info['data_url'],FLAGS.architecture)  
